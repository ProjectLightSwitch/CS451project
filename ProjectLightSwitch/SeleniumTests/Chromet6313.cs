...
namespace SeleniumTests
{
    ...
    public class ChromeT6313
    {
        ...
        public void TheT6313Test()
        {
            ...
            Assert.AreEqual("Project Light Switch - Tag Management", driver.Title);
            driver.FindElement(By.LinkText("Log off")).Click();
            Assert.AreEqual("Project Light Switch - Home Page", driver.Title);
        }
